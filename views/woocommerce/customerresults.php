...
$woocommerce = new Client(
    ...
    [
        'version' => 'wc/v3',
        'query_string_auth' => true,  // si besoin d’envoyer les clés dans l’URL (HTTPS recommandé)
        'timeout' => 30,
    ]
);

try {
    // Suppression définitive en passant 'force' => true
    $response = $woocommerce->delete('products/7951/variations/15057', ['force' => true]);

    echo "Produit supprimé définitivement :\n";
    print_r($response);
} catch (Exception $e) {

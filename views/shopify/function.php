...
class init
{
    static function InitShopify($host, $api_key, $password, $secret_key)
    {
        ...
        Context::initialize($api_key, $secret_key, Html::encode($scopes), $host, new FileSessionStorage(__DIR__ . '/tmp/php_sessions'));

        $client = new Graphql($host, $password);

...
function InitShopify()
{
    ...
    Context::initialize($model->api_key, $model->secret_key, Html::encode($scopes), $model->url, new FileSessionStorage(__DIR__ . '/tmp/php_sessions'));

    $client = new Graphql($model->url, $model->password);

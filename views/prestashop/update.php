...
<style>
    .prestashop-update .card {
        border-radius: 10px;
        overflow: hidden;
        box-shadow: 0 4px 15px rgba(0,0,0,0.08);
    }
    
    .prestashop-update .card-header {
        border-radius: 10px 10px 0 0 !important;
    }
    
    .prestashop-update .btn {
        border-radius: 20px;
    ...
    .prestashop-update .btn:hover {
        transform: translateY(-2px);
        box-shadow: 0 4px 12px rgba(241, 172, 22, 0.3);
    }
    
    .prestashop-update .form-control {
        border-radius: 8px;
    ...
    .prestashop-update .form-control:focus {
        border-color: #f1ac16;
        box-shadow: 0 0 0 0.2rem rgba(241, 172, 22, 0.25);
    }
    
    .prestashop-update .btn-primary {
        background-color: #f1ac16;
        border-color: #f1ac16;
    }
    
    .prestashop-update .btn-primary:hover {
...
$(document).ready(function() {
    ...
    $('.prestashop-update .card').css('opacity', '0').animate({opacity: 1}, 500);
    
    // Animation pour les champs de formulaire
    $('.prestashop-update .form-control').on('focus', function() {
